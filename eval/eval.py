...
python eval.py --gpu_id=<gpu list> -n <expname> -c <conf> -D /home/group/dataset/chairs -F srn
"""
import sys
import os
...
def extra_args(parser):
    parser.add_argument(
        ...
        type=str,
        default="test",
        help="Split of dataset to use train | val | test",
    )
    parser.add_argument(
        "--source",
        "-P",
...
data_loader = torch.utils.data.DataLoader(
    dset, batch_size=1, shuffle=False, num_workers=0, pin_memory=False # linux num_workersΪ8
)
